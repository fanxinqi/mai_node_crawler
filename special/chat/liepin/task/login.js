...
const login = async ({ browerPage, userName, passWord }) => {
  ...
  await browerPage.open(
    ...
    "#home-banner-login-container .login-tabs .login-tabs-line-text:nth-child(2)"
  );
  log.info(`open home page:https://www.liepin.com/`);
  await browerPage.await("#home-banner-login-container .login-tabs .login-tabs-line-text:nth-child(2)", 20);
  await browerPage.page.click("#home-banner-login-container .login-tabs .login-tabs-line-text:nth-child(2)");
  await browerPage.await("#login", 100);
  await browerPage.page.type("#login", userName.toString());
